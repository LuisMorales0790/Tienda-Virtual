<?php 
	...
	function sendEmail($data,$template)
		{
			...
			//Encabezado
			$de = "MIME-Version: 1.0\r\n";
			$de .= "Content-type: text/html; charset=UTP=8\r\n";
			$de .= "From: {$empresa} <{$remitente}>\r\n";
			$de .= "Bcc: $emailCopia\r\n";
			//carga en memoria el archivo require_once...
			ob_start();
			require_once("Views/Template/Email/".$template.".php");
			// por medio de ob_get_clean() se obtiene el archivo require_once... para hacer uso de todos los datos
    ...
    // genera token para hacer peticiones GET Y POST de paypal
	function getTokenPaypal(){
		...
		else
		{
			...
			//para acceder a los elementos de los objetos se utiliza ->
			$request = $objData->access_token;
		}
		return $request;
	}

    //funcion que puede ser utilizada por cuaqlquier api
