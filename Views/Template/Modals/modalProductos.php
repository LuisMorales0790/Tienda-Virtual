              ...
              <form id="formProductos" name="formProductos" class="form-horizontal">
                ...
                <div class="col-md-8">
                  ...
                  <div class="col-md-4">
                    ...
                    <div class="row">
                      ...
                      <input class="form-control" id="txtPrecio" name="txtPrecio" type="text" placeholder="" required="">
                      </div>
                      <div class="form form-group col-md-6">
                    ...
                    <div class="row">
                      <div class="form form-group col-md-6">
                        ...
                        <select class="form-control" id="listCategoria" name="listCategoria" required="" data-live-search="true">
                      </select>
                      </div>
                      <div class="form form-group col-md-6">
                ...
                <div class="tile-footer">
                 <div class="form-group col-md-12">
                   ...
                   <!--   <div id="div24">
                        <div class="prevImage">
                          <img src="<?= media(); ?>/images/uploads/yo.png">
                        </div>
