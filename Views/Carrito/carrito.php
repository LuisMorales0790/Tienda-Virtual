			...
			<div class="row">
				...
				<div class="col-sm-10 col-lg-7 col-xl-5 m-lr-auto m-b-50">
					<div class="bor10 p-lr-40 p-t-30 p-b-40 m-l-63 m-r-40 m-lr-0-xl p-lr-15-sm">
						...
						<a href="<?= base_url() ?>/carrito/procesarpago" id="btmComprar" class="flex-c-m stext-101 cl0 size-116 bg3 bor14 hov-btn3 p-lr-15 trans-04 pointer">
							Procesar pago
						</a>
					</div>
				</div>
...
<br>	
<div class="container">
		<p>No Hay producto en el carrito <a href="<?= base_url() ?>/tienda">Ver producto</a></p>	
</div>
<br>	
<?php 
 		}
