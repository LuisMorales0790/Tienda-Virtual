            ...
            <div class="row">
              ...
              <?php if ($reembolso) { ?>
                <table class="table table-sm">
                  ...
                  <tbody>
                    <!--Si es un usuario de tipo cliente -->
                    <?php if ($_SESSION['userData']['idrol'] == RCLIENTES) { ?>
                    <tr>
                      <th><?= $fechaReembolso.'Reembolso para '.$nombreCliente ?></th>
                      <th class="text-right">- <?= $importeBruto.' '.$moneda ?></th>
                      <th class="text-right">0.00</th>
                      <th class="text-right">- <?= $importeBruto.' '.$moneda ?></th>
                    </tr>
                    <?php }else{ ?>
                    <tr>
                      <!--Si no es un usuario de tipo cliente -->
                      <th><?= $fechaReembolso.'Reembolso para '.$nombreCliente ?></th>
                      <th class="text-right">- <?= $importeBruto.' '.$moneda ?></th>
                      <th class="text-right">- <?= $comisionPaypal.' '.$moneda ?></th>
                      <th class="text-right">- <?= $importeNeto.' '.$moneda ?></th>
                    </tr>

                    <tr>
                      <th><?= $fechaReembolso ?>Cancelación de la comision de PayPal</th>
                      <th class="text-right">- <?= $comisionPaypal.' '.$moneda ?></th>
                      <th class="text-right">0.00 <?= $moneda ?></th>
                      <th class="text-right">- <?= $comisionPaypal.' '.$moneda ?></th>
                    </tr>
                    <?php } ?>
                  </tbody>
