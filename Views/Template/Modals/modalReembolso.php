  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
          ...
          <table class="table table-bordered">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>Nombre: <?= $nombreCliente ?> <br>Correo: <?= $emailCliente ?> <br>Telefono: <?= $telCliente ?> </td>
              </tr>
              <tr>
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-primary" onclick="fntReembolsar()"><i class="fa fa-reply-all" aria-hidden="true"></i>Reembolso</button>
