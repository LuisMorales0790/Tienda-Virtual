<?php 
	...
	class ClientesModel extends Mysql
	{
		...
		public function updateCliente(int $idUsuario, string $identificacion, string $nombre, string $apellido, string $telefono, string $email, string $password, string $strnit, string $strnomfiscal, string $strdirfiscal)
		{
			...
			//consulta para verificar si el email o la identificacion ya existe si existen se deben cambiar
			...
			{
				//ya existe este correo y esta identificacion.
				$request = "exist";
			}
		...
		public function deleteCliente(int $intIdpersona)
		{
			...
			$sql = "UPDATE persona SET status = ? WHERE idpersona = $this->intIdUsuario and rolid=7";
