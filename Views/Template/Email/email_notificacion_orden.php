...
<body>
	<div>
		<br>
		<p class="text-center">Se ha generado una orden, a continuacíon encontrarás los datos.</p>
		<br>
		<hr>
		<br>
		<table>
			<tr>
				...
				<td width="33.33%">
					<div class="text-center">
						<h4><strong><?= NOMBRE_EMPRESA ?></stroNOMBRE_EMPRESAng></h4>
						<p>
							<?= DIRECCION ?> <br>
		...
		<table>
			...
			<tfoot>
				...
				<tr>
					...
					<td class="text-right"><?= SMONEY.' '.formatMoney($total = $subtotal + $orden['costo_envio']); ?></td>
				</tr>
			</tfoot>
		</table>
		<div class="text-center">
			<p>Si tienes preguntas sobre tu pedido, <br>pongase en contacto con nombre, telefono y Email</p>
