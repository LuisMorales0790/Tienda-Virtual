 ...
 ?>	
	...
	<div class="sec-banner bg0 p-t-80 p-b-50">
		<div class="container">
			<div class="row">
				<?php 	
					for ($b	=0; $b	 < count($arrBanner) ; $b	++)
					{ 
						$ruta = $arrBanner[$b]['ruta'];
				 ?>
				<div class="col-md-6 col-xl-4 p-b-30 m-lr-auto">
					<!-- Block1 -->
					<div class="block1 wrap-pic-w">
						<img src="<?= $arrBanner[$b]['portada']?>" alt="<?= $arrBanner[$b]['nombre']?>">

						<a href="<?= base_url().'/tienda/categoria/'.$arrBanner[$b]['idcategoria'].'/'.$ruta; ?>" class="block1-txt ab-t-l s-full flex-col-l-sb p-lr-38 p-tb-34 trans-03 respon3">
